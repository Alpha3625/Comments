...
const clearBtn = form.querySelector(".clear__button");

const commentList = document.querySelector(".comment-list");


// ___________________________________________ Отправить сообщение
...
// ___________________________________________ Поставить лайк
...
// ___________________________________________ Удалить последнее сообщение
